...
- What problems do you face while trying to do (_given task_)? (select all that apply)

Here’s some examples of what good user interview questions may look like:

- How do you currently go about doing (_given task_)?
- What do you like about how you currently perform (_given task_)?
- What is the biggest pain point when performing (_given task_)?
